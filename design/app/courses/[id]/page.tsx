...
import { EXERCISES, MODULE_1_SECTIONS, MODULES, getModule } from "@/lib/data";
    ...
    <div>
      <div className="bg-ink px-5 pb-6 pt-6 text-paper lg:px-10 lg:pb-10 lg:pt-9">
        <div className="mx-auto flex max-w-[880px] flex-col gap-3.5">
          <Link href="/courses" className="text-[13px] text-ink-mute hover:text-paper">
            ← Beginner course
          </Link>
          <div>
        ...
        <div className="mx-auto flex max-w-[880px] flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            {MATERIALS.map((doc) => (
              ...
              >
                <span className="font-mono text-[10px] font-semibold text-teal-deep">
                  {doc.kind}
                </span>
