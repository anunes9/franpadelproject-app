...
const NAV = [
  { href: "/", label: "Dashboard", tab: "Home" },
  { href: "/courses", label: "Courses", tab: "Courses" },
  { href: "/exercises", label: "Exercises", tab: "Exercises" },
  { href: "/plan", label: "Weekly plan", tab: "Plan" },
  { href: "/profile", label: "Profile", tab: "Profile" },
];
...
export function PageHeader({
  ...
  return (
    <div className="flex items-end justify-between gap-6">
      ...
      {withLanguage ? <LanguageToggle /> : null}
    </div>
  );
}
