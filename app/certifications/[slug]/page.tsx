  ...
  return (
    <div>
      ...
      <h2 className="text-2xl mt-6 mb-4 lg:p-4">
        Teste de Certificação Fran Methodology sobre os módulos do curso de
        Beginner
      </h2>
      ...
      <div className="lg:px-8">
        <MesoHeader
          title="Mesociclo 1"
          concept="Serviço, Resposta ao Serviço e 1º Volley"
        />
        <MesoHeader title="Mesociclo 2" concept="Conceito 5 em Linha" />

        {certification.error && (
          <p className="text-red-500">Erro ao obter a certificação</p>
        )}
