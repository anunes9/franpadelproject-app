...
export function DayCard({ dayName, date, dayOfWeek, items, onAddItem, onRemoveItem, isToday = false }: DayCardProps) {
  // Group items by type
  ...
  return (
    <Card className={`h-full flex flex-col ${isToday ? 'ring-2 ring-primary' : ''}`}>
      ...
      <CardContent className="flex-1 flex flex-col gap-3">
        ...
        {/* Add button */}
        <Button variant="outline" size="sm" onClick={onAddItem} className="w-full mt-auto">
