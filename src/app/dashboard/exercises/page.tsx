...
import { ArrowLeft, Search, Play, Clock, Target, Zap, Users, Filter } from "lucide-react"
...
export default function ExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Page Header */}
      <div className="bg-gradient-to-r from-accent/10 to-primary/10 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-foreground mb-2">Exercise Library</h1>
              <p className="text-muted-foreground text-lg mb-4">
                Comprehensive collection of padel drills and training exercises
              </p>
            ...
            <div className="mt-6 md:mt-0">
              <div className="text-center">
                <div className="text-2xl font-bold text-accent mb-1">{completedExercises}</div>
